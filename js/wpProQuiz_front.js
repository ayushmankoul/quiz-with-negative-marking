...
//					plugin.methode.showQuizSummary();
            ...
            finishQuiz: function (timeover) {
                ...
                config.globalPoints = total_questions
                var total_questions = globalElements.questionList.children().length
                var correct_questions = results.comp.correctQuestions
                var incorrect_questions = total_questions - correct_questions
                var points_scored = correct_questions - 0.33 * incorrect_questions
                config.globalPoints = total_questions
                results.comp.points = points_scored
                results.comp.result =Math.round(points_scored*100)/100
